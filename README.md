...
```text
?tenant=acme&region=reg22&device=nuc-001
```

Example:

```text
https://<deployment-domain>/?tenant=acme&region=reg22&device=nuc-001
```
...
5. test one launcher such as `/devices/reg22/nuc-001.html`
