...
This folder is the region-default content layer for `reg22`.
...
- `regions/reg22/data/primary-assets.json`
- `regions/reg22/data/primary.json`
- `regions/reg22/data/footer.json`
- `regions/reg22/data/primaryending.json`
- `regions/reg22/assets/primary/manifest.json`
- `regions/reg22/assets/footer/manifest.json`
...
Use this folder for region-wide defaults that should affect `reg22`.
